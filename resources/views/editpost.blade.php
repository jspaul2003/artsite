...
@section('data')
    @if(Auth::check())
        <div class="container">
            ...
            <h3 class="jumbotron">Update Art Or Writing</h3>

            <form method="post" action="/art/{{$id}}/updater" class='texts'>
            ...
            <form method="post" action="/art/{{$id}}/updater" enctype="multipart/form-data"
        ...
        "
            ...
            >
                ...
                @elseif(isset($tags))
                    ...
                    <input type="hidden" name="title"  id='titlei' value={{$tags}}>
                    <input type="hidden" name="description"  id='descriptioni' value={{$description}}>
                    <input type="hidden" name="tags" id='tagsi' value={{$tags}}>
                @else
                ...
                <div class="dz-message" data-dz-message><span id="dzmessage">Drag & Drop your new or updated Art here or <p id="extracom">browse</p></span></div>
                @csrf
            ...
            <form method="post" action="/art/{{$id}}/updater" id='descid' class='texts'  >
            ...
            <form method="post" action="/art/{{$id}}/updater" id='tagid' class='texts' >
                <div id='tags'>
                    @if(isset($error_data))
                        {!! $error_data[3]!!}
                    @elseif(isset($tags))
